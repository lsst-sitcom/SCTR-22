...
this year, most likely in May.
    ...
    \begin{minipage}[]{9cm}
    \smallskip
    Still need to understand the initial forces, why is that different from
the LUT table in the code repo.
    \medskip
    \end{minipage}
    &
    \\\hline
...
Final comment:\\Still need to understand the initial forces, why is that different from
the LUT table in the code repo.
