...
To prevent the replacement of an actuator from interfering with
observing time, the total replacement time is limited to 6 hours. To
provide sufficient time for setup, cleanup and calibration the total
time allocated to the physical removal is limited to 3 hours.~
